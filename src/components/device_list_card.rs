...
pub fn DeviceListCard(device: Device, children: Children) -> impl IntoView {
    let icon = match device.device_type {
        ...
        /*
        DeviceType::AndroidTv => view!{<svg></svg>},
        DeviceType::AppleTv => view!{<svg></svg>},
        DeviceType::Chromecast => view!{<svg></svg>},
        DeviceType::Kodi => view!{<svg></svg>},
        DeviceType::LGTv => view!{<svg></svg>},
        DeviceType::Plex => view!{<svg></svg>},
        DeviceType::SamsungTv => view!{<svg></svg>},
        DeviceType::Tivo => view!{<svg></svg>},
        DeviceType::VizioTV => view!{<svg></svg>},
        DeviceType::Spotify => view!{<svg></svg>},
        DeviceType::Sonos => view!{<svg></svg>},
        DeviceType::HueLight => view!{<svg></svg>},
        DeviceType::Macbook => view!{<svg></svg>},
        DeviceType::Minecraft => view!{<svg></svg>},
        DeviceType::BrotherPrinter => view!{<svg></svg>},
        DeviceType::Roomba => view!{<svg></svg>},
        */
    };
